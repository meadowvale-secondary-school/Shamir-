 ...
 */
var walkingChallenges: [String] = ["Walk 1 kilo", "Walk 2 kilos" , "Walk 3 kilos" ]
var runningChallenge:[String] = ["Run 5 times a week", "Run 2 times a week", "Run 3 times a week "]
/*:
 ...
 */
var challenges = [walkingChallenges, runningChallenge]
...
if committedChallenges.isEmpty {
    print("Please select a challenge.")
