 ...
 */
print("I would expect 10 divided by 3 to be a whole number since Swift will round it up to the nearest whole number.")
...
print("This value differs since in the integer divison the answer is in whole number while here is in decimal form.")
/*:
