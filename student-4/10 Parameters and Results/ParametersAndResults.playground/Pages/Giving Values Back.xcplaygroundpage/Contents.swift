 ...
 */
func makeFavourite (categoryofThing:String, favourite:String) -> String {
    let sentence = "My favourite \(categoryofThing) is \(favourite)"
    return sentence
}
...
makeFavourite(categoryofThing: "movie", favourite: "The Dark Knight")
