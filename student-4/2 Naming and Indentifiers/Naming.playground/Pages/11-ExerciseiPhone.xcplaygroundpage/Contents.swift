...
let iphoneStorageRemaining = iphoneStorage - storageUsed
let OneMinuteVideo = 150
//Total Minutes
let totalMinutes = iphoneStorageRemaining/OneMinuteVideo
print("The total minutes you can take on your Iphone is",totalMinutes)
