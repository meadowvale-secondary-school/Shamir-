 ...
 */
let ApplesWeight = 100
let OrangesWeight = 30
let CokesWeight = 50
let painoWeight = 600
let couchWeight = 200
let smallHorse = 1000
...
var addLoadtoBasket = ApplesWeight + OrangesWeight + CokesWeight
ricketyRope.addLoadToBasket(loadWeight: ApplesWeight + OrangesWeight + CokesWeight)
ricketyRope.canHandleAdditionalLoad(addLoadtoBasket)
print("Pulley 1 =", ricketyRope)
ricketyRope2.addLoadToBasket(loadWeight: painoWeight + couchWeight + smallHorse)
ricketyRope2.canHandleAdditionalLoad(addLoadtoBasket)
print("Pulley 2 = ", ricketyRope2)
/*:
 - callout(Exercise):
