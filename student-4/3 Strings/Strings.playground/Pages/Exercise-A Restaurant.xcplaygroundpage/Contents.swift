...
let serverResponsetoTableTwo = "Let see you want \(customerOrderFour), \(customerOrderFive) and \(customerOrderSix)"
let TableTwoResponse = "Merci"
/*:
...
print ("hey there", serverResponseToTableOne)
